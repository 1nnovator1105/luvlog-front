            ...
            <div className={'login-container'}>
                <div className={'login-form'}>
                    ...
                    <div>
                        ...
                        <input type="text" name="username" value={userInfo.username} onChange={onChangeHandler}/>
                    </div>
                    <div>
                        <span className={'login-span'}>PW</span>
                        <input type="password" name="password" value={userInfo.password} onChange={onChangeHandler}/>
                    </div>
                    <div>
                        <input type="button" value={'로그인'} onClick={loginHandler}/>
                        <input type="button" value={'회원가입'}/>
                    </div>
                    <p className={'login-guest'}>&#x1F449;<span onClick={props.setGuestMode}>Guest</span></p>
                </div>
            </div>
        </>
    )
